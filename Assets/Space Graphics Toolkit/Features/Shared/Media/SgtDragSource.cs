...
namespace SpaceGraphicsToolkit
{
	...
	[ExecuteInEditMode]
	[HelpURL(SgtHelper.HelpUrlPrefix + "SgtDragSource")]
	[AddComponentMenu(SgtHelper.ComponentMenuPrefix + "Drag Source")]
...
namespace SpaceGraphicsToolkit
{
	...
	[CustomEditor(typeof(SgtDragSource))]
	public class SgtDragSource_Editor : SgtEditor<SgtDragSource>
	{
