...
namespace SpaceGraphicsToolkit
{
	...
	public class SgtFloatingOrbitVisual : MonoBehaviour
	{
		...
		public SgtLength Thickness { set { thickness = value; } get { return thickness; } } [FSA("Thickness")] [SerializeField] private SgtLength thickness = 100000.0f;

		/// <summary>The amount of points used to draw the orbit.</summary>
		public int Points { set { points = value; } get { return points; } } [FSA("Points")] [SerializeField] private int points = 360;
