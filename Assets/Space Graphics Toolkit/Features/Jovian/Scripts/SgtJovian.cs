...
namespace SpaceGraphicsToolkit
{
	...
	public class SgtJovian : MonoBehaviour
	{
		...
		public Cubemap FlowTex { set { if (flowTex != value) { flowTex = value; UpdateMaterial(); } } get { return flowTex; } } [SerializeField] private Cubemap flowTex;

		/// <summary>The speed of the jovian texture flow.</summary>
		public float FlowSpeed { set { if (flowSpeed != value) { flowSpeed = value; UpdateMaterial(); } } get { return flowSpeed; } } [SerializeField] private float flowSpeed = 1.0f;

		/// <summary>The maximum distance the jovian texture can flow in UV space.</summary>
		public float FlowStrength { set { if (flowStrength != value) { flowStrength = value; UpdateMaterial(); } } get { return flowStrength; } } [SerializeField] private float flowStrength = 0.01f;
		...
		public float FlowNoiseTiling { set { if (flowNoiseTiling != value) { flowNoiseTiling = value; UpdateMaterial(); } } get { return flowNoiseTiling; } } [SerializeField] private float flowNoiseTiling = 1.0f;
		...
		public float DistanceRadius { set { if (distanceRadius != value) { distanceRadius = value; UpdateMaterial(); } } get { return distanceRadius; } } [SerializeField] private float distanceRadius = 0.9f;
